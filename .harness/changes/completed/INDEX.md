...
> 每个完成项维护日期、标题、文件、commit、PR 和仓库。新增或归档后必须同步更新本文件。
...
| 2026-08-06 | Codex 原生 Harness 对齐 | [2026-08-06-codex-native-harness-alignment.md](2026-08-06-codex-native-harness-alignment.md) | 未登记 | 未登记 | agentops-harness |
| 2026-08-06 | Harness changes 团队协作 Git 同步增强 | [2026-08-06-harness-changes-git-sync-optimization.md](2026-08-06-harness-changes-git-sync-optimization.md) | 未登记 | 未登记 | agentops-harness |
| 2026-08-05 | Harness 架构优化 | [2026-08-05-harness-architecture-optimization.md](2026-08-05-harness-architecture-optimization.md) | 未登记 | 未登记 | agentops-harness |
| 2026-08-05 | Harness 状态与反馈优化 | [2026-08-05-harness-state-feedback-optimization.md](2026-08-05-harness-state-feedback-optimization.md) | 未登记 | 未登记 | agentops-harness |
...
| 2026-08-06 | Harness changes Git 同步增强执行计划 | [archive/2026-08-06-harness-changes-git-sync-optimization.md](archive/2026-08-06-harness-changes-git-sync-optimization.md) | 未登记 | 未登记 | agentops-harness |

## 维护规则

- 新增完成记录后，在“完成记录”表追加一行。
- 计划归档后，在“归档计划”表追加一行，并从 `changes/active/` 移除。
- 补到 commit / PR 信息时直接回填对应行，不要新开重复记录。
